...
\begin{figure}[t]
	\centering
	\subfloat[Number of requests per page]{\includegraphics[width=0.45\columnwidth]{theil_reqs}}\qquad
	\subfloat[Number of bytes per page]{\includegraphics[width=0.45\columnwidth]{theil_bytes}}
