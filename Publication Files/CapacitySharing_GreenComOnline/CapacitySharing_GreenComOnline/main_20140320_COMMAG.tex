\documentclass[letterpaper,journal,onecolumn,draftcls]{IEEEtran}
%% CCNC 2013 addition:
%\makeatletter
%\def\ps@headings{%
...
\begin{figure*}[]
	\centering
	\subfloat[Requests]{\includegraphics[width=.45\linewidth]{Sum_of_requests_over_time_overview}
	\label{fig:simr_zipf_reqs}}
	\hfil
	\subfloat[Bytes]{\includegraphics[width=.45\linewidth]{Sum_of_bytes_over_time_overview}
