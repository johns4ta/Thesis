...
\begin{figure*}[]
	\centering
	\subfloat[Requests]{\includegraphics[width=.4\linewidth]{Sum_of_requests_over_time}
	\label{fig:simr_abs_reqs}}
	\hfil
	\subfloat[Bytes]{\includegraphics[width=.4\linewidth]{Sum_of_bytes_over_time}
...
\begin{figure*}[]
	\centering
	\subfloat[Requests]{\includegraphics[width=.4\linewidth]{savings_Sum_of_requests_over_time}
	\label{fig:simr_sav_reqs}}
	\hfil
	\subfloat[Bytes]{\includegraphics[width=.4\linewidth]{savings_Sum_of_bytes_over_time}
...
%\begin{figure}
%	\centering
%	\includegraphics[width=.95\linewidth]{Sum_of_bytes_over_time_overview}
%	\caption{multiplied}
%	\label{fig:sim_saver}
%\end{figure}
%
