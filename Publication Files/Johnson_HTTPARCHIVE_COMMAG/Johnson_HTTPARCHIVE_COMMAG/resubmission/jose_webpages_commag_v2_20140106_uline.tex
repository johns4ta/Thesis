...
%	\includegraphics[width=.5\linewidth]{theil}
	\subfloat[Number of requests per page]{\includegraphics[angle=270,width=.45\textwidth]{theil/theil_reqs}}\qquad
	\subfloat[Number of bytes per page]{\includegraphics[angle=270,width=.45\textwidth]{theil/theil_bytes}}
...
\begin{figure}
\centering
	\subfloat[Average requests for desktop and mobile client versions.]{\includegraphics[angle=270,width=.45\textwidth]{requests_total/totalRequests_all}}\\ 
	
	\subfloat[Categorized requests for desktop client (all pages).]{\includegraphics[angle=270,width=.45\textwidth]{requests_by_type/req_by_type_fixed_all}}\qquad
%	\subfloat[Categorized requests for desktop client (subset).]{\includegraphics[angle=270,width=.4\textwidth]{requests_by_type/req_by_type_fixed}}\\
	\subfloat[Categorized requests for mobile client (all pages)]{\includegraphics[angle=270,width=.45\textwidth]{requests_by_type/req_by_type_mobile_all}}\qquad
%	\subfloat[Categorized requests for mobile client (subset)]{\includegraphics[angle=270,width=.4\textwidth]{requests_by_type/req_by_type_mobile}}\\
...
\begin{figure}
	\centering
	\subfloat[Averages for desktop and mobile client versions.]{\includegraphics[angle=270,width=.45\textwidth]{bytes_total/bytes_total_all}}\qquad
	\subfloat[Categorized for desktop client (all pages).]{\includegraphics[angle=270,width=.45\textwidth]{bytes_by_type/bytes_by_type_fixed_all}}\\
	\subfloat[Categorized for desktop client (subset).]{\includegraphics[angle=270,width=.45\textwidth]{bytes_by_type/bytes_by_type_fixed}}\qquad
	\subfloat[Categorized by category for mobile client (all pages).]{\includegraphics[angle=270,width=.45\textwidth]{bytes_by_type/bytes_by_type_mobile_all}}\qquad
%	\subfloat[Categorized by category for mobile client (subset).]{\includegraphics[angle=270,width=.45\textwidth]{bytes_by_type/bytes_by_type_mobile}}\\
...
\begin{figure}
	\centering
	\subfloat[Averages for desktop and mobile client versions.]{\includegraphics[angle=270,width=.45\textwidth]{bytes_per_request_total/bpr_all}}\\
	\subfloat[Categorized for desktop client (all pages).]{\includegraphics[angle=270,width=.4\textwidth]{bytes_per_request_by_type/bpr_by_type_fixed_all}}\qquad
%	\subfloat[Categorized for desktop client (subset).]{\includegraphics[angle=270,width=.4\textwidth]{bytes_per_request_by_type/bpr_by_type_fixed}}\\
	\subfloat[Categorized for  mobile client (all pages).]{\includegraphics[angle=270,width=.4\textwidth]{bytes_per_request_by_type/bpr_by_type_mobile_all}}
%	\subfloat[Categorized for  mobile client (subset).]{\includegraphics[angle=270,width=.4\textwidth]{bytes_per_request_by_type/bpr_by_type_mobile}}\\
...
\begin{figure}
	\centering
	\subfloat[Desktop clients]{\includegraphics[angle=270,width=.45\textwidth]{cache/cache_fix_all}}\qquad
	\subfloat[Mobile clients]{\includegraphics[angle=270,width=.45\textwidth]{cache/cache_mob_all}}\\
...
\begin{figure}
	\centering
	\subfloat[Average number of DOM elements in web pages for desktop clients only.]{\includegraphics[width=.475\linewidth]{dom_tot}}\qquad
	\subfloat[Average number of byte per requested web page object]{\includegraphics[width=.475\linewidth]{datreq}}\\
