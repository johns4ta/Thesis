...
\begin{figure}
\centering
	\subfloat[Average total number for desktop and mobile client versions.]{\includegraphics[width=.57\textwidth]{totalRequests}}\\
	\subfloat[Average number by category for desktop client versions.]{\includegraphics[width=.57\textwidth]{req_by_type_fixed}}\\
	\subfloat[Average number by category for mobile client versions.]{\includegraphics[width=.57\textwidth]{req_by_type_mobile}}\\
...
\begin{figure}
	\centering
	\subfloat[Average total amount for desktop and mobile client versions.]{\includegraphics[width=.57\textwidth]{bytes_total}}\\
	\subfloat[Average amount by category for desktop client versions.]{\includegraphics[width=.57\textwidth]{bytes_by_type_fixed}}\\
	\subfloat[Average amount by category for mobile client versions.]{\includegraphics[width=.57\textwidth]{bytes_by_type_mobile}}\\
...
\begin{figure}
	\centering
	\subfloat[Average total amount for desktop and mobile client versions.]{\includegraphics[width=.57\textwidth]{bpr}}\\
	\subfloat[Average amount by category for desktop client versions.]{\includegraphics[width=.57\textwidth]{bpr_by_type_fixed}}\\
	\subfloat[Average amount by category for mobile client versions.]{\includegraphics[width=.57\textwidth]{bpr_by_type_mobile}}\\
...
\begin{figure}
	\centering
	\subfloat[Desktop clients]{\includegraphics[width=.57\textwidth]{cache_fix}}\\
	\subfloat[Mobile clients]{\includegraphics[width=.57\textwidth]{cache_mob}}\\
