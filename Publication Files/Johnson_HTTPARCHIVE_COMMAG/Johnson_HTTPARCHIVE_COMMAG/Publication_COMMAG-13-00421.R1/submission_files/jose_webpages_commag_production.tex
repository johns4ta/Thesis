...
\begin{figure}[t]
	\centering
	\subfloat[Number of requests per page]{\includegraphics[width=.45\textwidth]{theil_reqs}}\qquad
	\subfloat[Number of bytes per page]{\includegraphics[width=.45\textwidth]{theil_bytes}}
...
\begin{figure}
\centering
	\subfloat[Average requests for desktop and mobile client versions.]{\includegraphics[width=.45\textwidth]{totalRequests_all}}\\ 
	\subfloat[Categorized requests for desktop client (all pages).]{\includegraphics[width=.45\textwidth]{req_by_type_fixed_all}}\qquad
	\subfloat[Categorized requests for mobile client (all pages)]{\includegraphics[width=.45\textwidth]{req_by_type_mobile_all}}\qquad
...
\begin{figure*}
	\centering
	\subfloat[Averages for desktop and mobile client versions.]{\includegraphics[width=.45\textwidth]{bytes_total_all}}\qquad
	\subfloat[Categorized for desktop client (all pages).]{\includegraphics[width=.45\textwidth]{bytes_by_type_fixed_all}}\\
	\subfloat[Categorized for desktop client (subset).]{\includegraphics[width=.45\textwidth]{bytes_by_type_fixed}}\qquad
	\subfloat[Categorized by category for mobile client (all pages).]{\includegraphics[width=.45\textwidth]{bytes_by_type_mobile_all}}\qquad
...
\begin{figure}[]
	\centering
	\subfloat[Averages for desktop and mobile client versions.]{\includegraphics[width=.45\textwidth]{bpr_all}}\\
	\subfloat[Categorized for desktop client (all pages).]{\includegraphics[width=.45\textwidth]{bpr_by_type_fixed_all}}\qquad
	\subfloat[Categorized for  mobile client (all pages).]{\includegraphics[width=.45\textwidth]{bpr_by_type_mobile_all}}
...
\begin{figure}
	\centering
	\subfloat[Desktop clients]{\includegraphics[width=.45\textwidth]{cache_fix_all}}\qquad
	\subfloat[Mobile clients]{\includegraphics[width=.45\textwidth]{cache_mob_all}}\\
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{Troy_Johnson.jpg}}]{Troy Johnson}
received his Bachelor of Science in Computer Science from Central Michigan University, Mount Pleasant, in 2013 and is currently pursuing a Masters in Computer Science, also at Central Michigan University. His main research interests revolve around mobile and green computing.
 ...
 \begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{Patrick_Seeling.jpg}}]{Patrick Seeling} (S'03--M'05--SM'11)
