...
received his Bachelor of Science in Computer Science from Central Michigan University, Mount Pleasant, in 2013 and is currently pursuing a Masters in Computer Science, also at Central Michigan University. His main research interests revolve around mobile and green computing.
 ...
 \begin{IEEEbiography}[]{Patrick Seeling} (S'03--M'06--SM'11)
...
\begin{figure}[t]
	\centering
	\subfloat[Number of requests per page]{\includegraphics[width=.8\textwidth]{theil_reqs}}\\
	\subfloat[Number of bytes per page]{\includegraphics[width=.8\textwidth]{theil_bytes}}
...
\centering
	...
	\subfloat[Categorized requests for desktop client (all pages).]{\includegraphics[width=.45\textwidth]{req_by_type_fixed_all}}\\
...
\begin{figure}[t]
	...
	\subfloat[Categorized for desktop client (all pages).]{\includegraphics[width=.45\textwidth]{bpr_by_type_fixed_all}}\\
...
\begin{figure}[t]
	\centering
	\subfloat[Desktop clients]{\includegraphics[width=.9\textwidth]{cache_fix_all}}\\
	\subfloat[Mobile clients]{\includegraphics[width=.9\textwidth]{cache_mob_all}}\\
...
\clearpage
\newpage 
\includegraphics[width=.9\textwidth]{Troy_Johnson.jpg}\\
{Troy Johnson}


\clearpage
\newpage 
\includegraphics[width=.9\textwidth]{Patrick_Seeling.jpg}\\
{Patrick Seeling}
